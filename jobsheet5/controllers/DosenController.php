...
class DosenController{
    ...
    public function createDosen ($nidn,$nama,$home_based,$tempat_lahir,$tanggal_lahir,$jenis_kelamin,$agama,$alamat){
        return $this->model->createDosen($nidn,$nama,$home_based,$tempat_lahir,$tanggal_lahir,$jenis_kelamin,$agama,$alamat);
    }
    ...
    public function updateDosen($id,$nidn,$nama,$home_based,$tempat_lahir,$tanggal_lahir,$jenis_kelamin,$agama,$alamat){
        return $this->model->updateDosen($id,$nidn,$nama,$home_based,$tempat_lahir,$tanggal_lahir,$jenis_kelamin,$agama,$alamat);
    }
